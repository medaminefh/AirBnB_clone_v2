...
| 6. Console 0.0.1 | [console.py](https://github.com/medaminefh/AirBnB_clone/blob/main/console.py) | Add basic functionality to console program, allowing it to quit, handle empty lines and ^D |
